...
public class ExpandableTextView extends LinearLayout implements
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		// while an animation is in progress, intercept all the touch events to
		// children to
	...
	private void init(AttributeSet attrs) {
		...
		mExpandDrawable = typedArray
				.getDrawable(R.styleable.ExpandableTextView_expandDrawable);
	...
	public void setText(CharSequence text, SparseBooleanArray collapsedStatus,
			int position) {
	...
	private static int getRealTextViewHeight(TextView textView) {
		int textHeight = textView.getLayout().getLineTop(
